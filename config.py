...
GERMAN_TTS_MODELS = {
    ...
    # --- CrispASR native C++ TTS engines ---
    # These use the crispasr binary for fast, dependency-free synthesis.
    # Models are auto-downloaded from the CrispASR registry.
    "crispasr_kokoro": {
        ...
        "available_voices": ["af_heart", "af_sky", "af_bella", "af_nicole", "af_sarah",
                             "am_adam", "am_michael", "bf_emma", "bf_isabella",
                             "bm_george", "bm_lewis", "df_victoria"],
        "sample_rate": 24000,
        "notes": "CrispASR Kokoro TTS (C++ ggml). Fast, multi-voice. Apache 2.0.",
    },
    "crispasr_kokoro_de": {
        ...
        "available_voices": ["df_victoria"],
        "language": "de",
        "sample_rate": 24000,
        "notes": "CrispASR Kokoro German voice. Uses DE backbone + espeak-ng. Apache 2.0.",
    },
    "crispasr_orpheus": {
        ...
        "default_voice_id": "Tara",
        "available_voices": ["Anton", "Sophie", "Tara", "Leo", "Leah"],
        "sample_rate": 24000,
        "notes": "CrispASR Orpheus TTS (C++ ggml, SNAC codec). 5 preset speakers. llama3.2 license.",
    },
    "crispasr_orpheus_de": {
        ...
        "crispasr_codec_model": "auto",
        "default_voice_id": "Julian",
        "available_voices": ["Jakob", "Anton", "Julian", "Jan", "Alexander", "Emil",
                             "Ben", "Elias", "Felix", "Jonas", "Noah", "Maximilian",
                             "Sophie", "Marie", "Mia", "Maria", "Sophia", "Lina", "Lea"],
        "language": "de",
        "sample_rate": 24000,
        "notes": "CrispASR Kartoffel-Orpheus German Natural. 19 DE speakers. llama3.2 license.",
    },
    "crispasr_qwen3_tts": {
    ...
    "crispasr_chatterbox": {
        ...
        "available_voices": [],
        "sample_rate": 24000,
        "notes": "CrispASR Chatterbox TTS (C++ ggml CFM). MIT license.",
    },
    "crispasr_vibevoice_tts": {
        ...
        "available_voices": [],
        "sample_rate": 24000,
        "notes": "CrispASR VibeVoice TTS (C++ ggml). Voice cloning via --voice ref.wav.",
    },
    "crispasr_indextts": {
        ...
        "available_voices": [],
        "sample_rate": 24000,
        "notes": "CrispASR IndexTTS (C++ ggml, GPT-2 AR + BigVGAN). Zero-shot cloning. Apache 2.0.",
    },
    "crispasr_voxcpm2": {
    ...
    # --- Additional CrispASR native C++ TTS engines (v0.8.5+) ---
    "crispasr_bananamind_tts": {
        ...
        "language": "en",
        "sample_rate": 22050,
        "notes": "CrispASR BananaMind-TTS (C++ ggml, Tacotron-lite + HiFi-GAN). Character-based, en/de.",
    },
    "crispasr_dots_tts": {
        ...
        "available_voices": [],
        "sample_rate": 48000,
        "notes": "CrispASR Dots.TTS (C++ ggml, Qwen2.5 LLM + DiT + BigVGAN). 48 kHz, CAM++ voice cloning.",
    },
    "crispasr_cosyvoice3_tts": {
        ...
        "available_voices": [],
        "sample_rate": 24000,
        "notes": "CrispASR CosyVoice3 (C++ ggml, multi-GGUF: LLM+flow+CAM+++HiFT). Voice cloning.",
    },
    "crispasr_csm_tts": {
