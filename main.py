...
from config import GERMAN_TTS_MODELS, LM_STUDIO_API_URL_DEFAULT, OLLAMA_API_URL_DEFAULT
from utils import PYDUB_AVAILABLE as UTILS_PYDUB_AVAILABLE
from utils import SOUNDFILE_AVAILABLE as UTILS_SOUNDFILE_AVAILABLE
from utils import get_text_from_input, get_voice_info, list_available_models
...
def main_cli_entrypoint():
    ...
    api_group.add_argument("--lm-studio-api-url", type=str, default=LM_STUDIO_API_URL_DEFAULT if 'LM_STUDIO_API_URL_DEFAULT' in globals() else "http://127.0.0.1:1234/v1/completions", help="Override LM Studio API URL.")
    ...
    api_group.add_argument("--ollama-api-url", type=str, default=OLLAMA_API_URL_DEFAULT if 'OLLAMA_API_URL_DEFAULT' in globals() else "http://localhost:11434/api/generate", help="Override Ollama API URL.")
