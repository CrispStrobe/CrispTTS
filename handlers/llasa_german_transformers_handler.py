...
def synthesize_with_llasa_german_transformers(
    ...
    try:
        ...
        logger.info("LLaSA German: All primary models loaded.")
        ...
        if sample_audio_path and sample_audio_path.lower() != 'none':
            ...
            if resolved_ref_path.exists() and resolved_ref_path.is_file():
                ...
                logger.info("LLaSA German: Encoding reference audio...")
        ...
        with torch_llasa_german.no_grad():
            ...
            if is_cloning_mode:
                ...
                logger.info("LLaSA German: Trimmed reference audio portion")
        ...
        if play_direct:
            logger.info("LLaSA German: Playing audio...")
